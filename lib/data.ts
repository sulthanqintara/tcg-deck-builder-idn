...
export const mockCards: Card[] = [
  ...
  },
  {
    ...
    abilities: [],
    attacks: [
        { name: "Phantom Gate", cost: ["Psychic", "Colorless", "Colorless"], convertedEnergyCost: 3, damage: "", text: "Choose 1 of your opponent's Active Pokémon's attacks and use it as this attack." }
    ],
  ...
  },
  {
      ...
      hp: "180",
      attacks: [
          { name: "Dread Mountain", cost: ["Darkness", "Colorless"], convertedEnergyCost: 2, damage: "60+", text: "If your opponent's Active Pokémon is a Pokémon V, this attack does 60 more damage." }
      ],
      weaknesses: [{ type: "Grass", value: "x2" }],
  ...
  },
  {
      ...
      hp: "70",
      abilities: [
          { name: "Attract Customers", text: "Once during your turn, if this Pokémon is in the Active Spot, you may look at the top 6 cards of your deck, reveal a Supporter card you find there, and put it into your hand. Shuffle the other cards back into your deck.", type: "Ability" }
      ],
      attacks: [
          { name: "Surf", cost: ["Fire", "Water"], convertedEnergyCost: 2, damage: "50", text: "" }
      ],
      retreatCost: ["Colorless"],
      artist: "Jerky",
      legalities: { unlimited: "Legal", standard: "Legal", expanded: "Legal" },
  ...
  // Trainers
  {
    ...
    supertype: "Trainer",
    subtypes: ["Supporter"],
    rules: ["Choose 1 card from your hand and put it on the bottom of your deck. Then, draw 4 cards."],
    artist: "Ken Sugimori",
    regulationMark: "F",
    set: { id: "pfl", name: "Phantom Forces", ptcgoCode: "PFL" },
    number: "90",
  ...
  },
  {
    ...
    supertype: "Trainer",
    subtypes: ["Supporter"],
    rules: ["Search your deck for up to 2 Basic Energy cards of different types and attach them to your Pokémon in any way you like. Then, shuffle your deck."],
    artist: "Naoki Saito",
    regulationMark: "G",
  ...
  },
  {
      ...
      supertype: "Trainer",
      subtypes: ["Item"],
      rules: ["Look at the top 7 cards of your deck. You may reveal a Supporter card you find there and put it into your hand. Shuffle the other cards back into your deck."],
      artist: "Toyste Beach",
      regulationMark: "I",
  ...
  },
  {
      ...
      supertype: "Trainer",
      subtypes: ["Item"],
      rules: ["Discard 2 cards from your hand. If you do, search your deck for a Pokémon, reveal it, and put it into your hand. Then, shuffle your deck."],
      artist: "5ban Graphics",
      regulationMark: "E",
      set: { id: "meg", name: "Mega Sets", ptcgoCode: "MEG" },
      number: "131",
  ...
  },
  {
      ...
      supertype: "Trainer",
      subtypes: ["Item"],
      rules: ["Search your deck for a Pokémon ex, reveal it, and put it into your hand. Then, shuffle your deck."],
